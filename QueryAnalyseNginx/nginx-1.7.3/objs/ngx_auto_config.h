#define NGX_CONFIGURE " --prefix=/data/fuyitao/QueryProcess/QueryAnalyseNginx/viw/nginx --with-pcre=../pcre-8.35 --with-zlib=../zlib-1.2.8 --with-openssl=../openssl-1.0.1h --add-module=/data/fuyitao/QueryProcess/QueryAnalyseNginx/test"

#ifndef NGX_COMPILER
#define NGX_COMPILER  "gcc 4.4.6 20120305 (Red Hat 4.4.6-4) (GCC) "
#endif
...
#ifndef NGX_PREFIX
#define NGX_PREFIX  "/data/fuyitao/QueryProcess/QueryAnalyseNginx/viw/nginx/"
#endif
