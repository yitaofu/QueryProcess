...
int main(){
	...
	char str[1024] = "shopid=1234&keyword=JDSK连衣裙ABCdE&encode=1234";
	cout << "输入：" << str << endl; 
	...
	char str1[1024] = "keyword=456789&encode=1234&buyerid=165872276";
	cout << "输入：" << str1 << endl; 
	...
	char str2[1024] = "keyword=韩版&连衣裙&encode=1231233&buyerid=165872390";
	cout << "输入：" << str2 << endl;
